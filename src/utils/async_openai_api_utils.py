...
def embed(prompts, embedding_model="text-embedding-3-small", dimensions=1024, batch_size=500, api_key=None):
    ...
    embeddings = run_sync(client.get_embeddings(prompts))
...
def chat(
    ...
    Args:
        ...
        chat_config: Config to use for model
    ...
    # Get completions
    responses = run_sync(client.get_chat_completions(requests))
